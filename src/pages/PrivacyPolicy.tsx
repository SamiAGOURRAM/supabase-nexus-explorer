      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-card rounded-xl border border-border p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              <li><strong>Withdraw your consent</strong> at any time by contacting us at inf.shbm@um6p.ma</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-muted-foreground text-sm">
                  You can withdraw your consent at any time by contacting inf.shbm@um6p.ma or through your profile settings.
                </p>
              </div>
              <div className="border-l-4 border-primary pl-4">
            ...
            <p className="text-muted-foreground mt-4">
              To exercise any of these rights, please contact us at <strong>inf.shbm@um6p.ma</strong> or 
          ...
          <section>
            ...
            <div className="bg-muted rounded-lg p-4">
              <p className="text-foreground">
                <strong>Email:</strong> <a href="mailto:inf.shbm@um6p.ma" className="text-primary hover:underline">inf.shbm@um6p.ma</a>
              </p>
