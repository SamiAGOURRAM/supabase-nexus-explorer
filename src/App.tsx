...
const StudentCompanyProfile = lazy(
  () => import("./pages/student/CompanyProfile")
);
    ...
    <BrowserRouter>
      <Suspense fallback={<LoadingScreen />}>
        <Routes>
          ...
          <Route
            path="/admin/events/:id/quick-invite"
            element={<QuickInvite />}
          />
          <Route
          ...
          <Route
            path="/admin/events/:id/companies"
            element={<EventCompanies />}
          />
          <Route
            path="/admin/events/:id/companies/:companyId"
            element={<CompanyDetail />}
          />
          <Route
            path="/admin/events/:id/students"
            element={<EventStudents />}
          />
